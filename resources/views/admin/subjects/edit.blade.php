        ...
        <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    <h6 class="text-white text-capitalize ps-3 mb-0">Edit Subject</h6>
                </div>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.subjects.update', $subject) }}" class="row g-3">
                    ...
                    <div class="col-md-2">
                        <div class="input-group input-group-static mb-4">
                            ...
                            <input type="number" class="form-control" id="units" name="units" min="1" max="6" value="{{ old('units', $subject->units) }}" required>
                            @error('units')
                                <span class="text-danger text-xs">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn bg-gradient-primary">Update Subject</button>
